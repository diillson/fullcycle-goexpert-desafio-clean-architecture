...
func (ec *executionContext) field_Mutation_createOrder_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCreateOrderInput2fullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐCreateOrderInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Order)
	fc.Result = res
	return ec.marshalNOrder2ᚖfullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖfullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputCreateOrderInput(ctx context.Context, obj any) (CreateOrderInput, error) {
	...
	fieldsInOrder := [...]string{"customerId", "amount", "status"}
...
func (ec *executionContext) unmarshalNCreateOrderInput2fullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐCreateOrderInput(ctx context.Context, v any) (CreateOrderInput, error) {
...
func (ec *executionContext) marshalNOrder2fullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐOrder(ctx context.Context, sel ast.SelectionSet, v Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖfullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖfullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖfullcycleᚑgoexpertᚑdesafioᚑcleanᚑarchitectureᚋinternalᚋgraphqlᚐOrder(ctx context.Context, sel ast.SelectionSet, v *Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
